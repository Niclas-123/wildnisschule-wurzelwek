...
SeminarType.new(name: "Wanderungen", description: "Wanderungen folgen einem Urinstinkt des Menschen - zu nomadisieren und umherzustreifen. Deshalb werden diese Tage gerne auch in innerer Ruhe verbracht, um ganz Ohr und Nase für die Natur zu sein.").save(validate: false)
